...
// EndpointIPAddressAndPortExtensions is a generated type-safe wrapper for extensions.
type EndpointIPAddressAndPortExtensions struct {
}

func (s *EndpointIPAddressAndPortExtensions) Encode(w *per.Encoder) error {
...
func (s *EndpointIPAddressAndPortExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
