...
func (msg *GNBCUCPE1SetupRequest) EncodeWithEncoder(e *per.Encoder) (err error) {
	ies, err := msg.toIes()
	if err != nil {
		return err
	}
...
// Decode implements the MessageUnmarshaller interface for GNBCUCPE1SetupRequest.
func (msg *GNBCUCPE1SetupRequest) Decode(data []byte) (diagList []CriticalityDiagnosticsIEItem, err error) {
	r := per.NewDecoder(data, per.APER)
	return msg.DecodeFromDecoder(r)
}

func (msg *GNBCUCPE1SetupRequest) DecodeFromDecoder(r *per.Decoder) (diagList []CriticalityDiagnosticsIEItem, err error) {
...
func (decoder *GNBCUCPE1SetupRequestDecoder) decodeIE(r *per.Decoder) (msgIe *E1APMessageIE, err error) {
