...
func (s *PDUSessionResourceFailedModItem) Encode(w *aper.AperWriter) (err error) {
...
func (s *PDUSessionResourceFailedModItem) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for PDUSessionResourceFailedModItem */
	}
	return nil
}
