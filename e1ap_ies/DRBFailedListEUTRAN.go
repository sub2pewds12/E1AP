...
func (s *DRBFailedListEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBFailedListEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBFailedItemEUTRAN, length)
