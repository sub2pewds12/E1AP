...
// MaximumIPdatarateExtensions is a generated type-safe wrapper for extensions.
type MaximumIPdatarateExtensions struct {
}

func (s *MaximumIPdatarateExtensions) Encode(w *per.Encoder) error {
...
func (s *MaximumIPdatarateExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
