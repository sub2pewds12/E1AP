...
// DRBSetupItemNGRANExtensions is a generated type-safe wrapper for extensions.
type DRBSetupItemNGRANExtensions struct {
}

func (s *DRBSetupItemNGRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBSetupItemNGRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
