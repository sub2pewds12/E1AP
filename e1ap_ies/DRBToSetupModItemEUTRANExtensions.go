...
// DRBToSetupModItemEUTRANExtensions is a generated type-safe wrapper for extensions.
type DRBToSetupModItemEUTRANExtensions struct {
}

func (s *DRBToSetupModItemEUTRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBToSetupModItemEUTRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
