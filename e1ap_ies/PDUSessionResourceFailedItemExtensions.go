...
// PDUSessionResourceFailedItemExtensions is a generated type-safe wrapper for extensions.
type PDUSessionResourceFailedItemExtensions struct {
}

func (s *PDUSessionResourceFailedItemExtensions) Encode(w *per.Encoder) error {
...
func (s *PDUSessionResourceFailedItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
