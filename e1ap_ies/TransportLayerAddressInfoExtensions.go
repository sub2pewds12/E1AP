...
// TransportLayerAddressInfoExtensions is a generated type-safe wrapper for extensions.
type TransportLayerAddressInfoExtensions struct {
}

func (s *TransportLayerAddressInfoExtensions) Encode(w *per.Encoder) error {
...
func (s *TransportLayerAddressInfoExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
