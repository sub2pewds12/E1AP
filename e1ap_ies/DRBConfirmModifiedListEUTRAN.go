...
func (s *DRBConfirmModifiedListEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBConfirmModifiedListEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBConfirmModifiedItemEUTRAN, length)
