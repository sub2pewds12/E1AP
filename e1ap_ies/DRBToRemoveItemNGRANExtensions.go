...
// DRBToRemoveItemNGRANExtensions is a generated type-safe wrapper for extensions.
type DRBToRemoveItemNGRANExtensions struct {
}

func (s *DRBToRemoveItemNGRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBToRemoveItemNGRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
