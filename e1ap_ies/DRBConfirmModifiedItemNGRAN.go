...
type DRBConfirmModifiedItemNGRAN struct {
	...
	IEExtensions         *DRBConfirmModifiedItemNGRANExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *DRBConfirmModifiedItemNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBConfirmModifiedItemNGRAN) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(2) {
		s.IEExtensions = new(DRBConfirmModifiedItemNGRANExtensions)
