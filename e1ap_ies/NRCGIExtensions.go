...
// NRCGIExtensions is a generated type-safe wrapper for extensions.
type NRCGIExtensions struct {
}

func (s *NRCGIExtensions) Encode(w *per.Encoder) error {
...
func (s *NRCGIExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
