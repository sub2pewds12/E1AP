...
func (s *PDUSessionResourceModifiedList) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceModifiedList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]PDUSessionResourceModifiedItem, length)
