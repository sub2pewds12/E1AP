...
// RedundantPDUSessionInformationExtensions is a generated type-safe wrapper for extensions.
type RedundantPDUSessionInformationExtensions struct {
}

func (s *RedundantPDUSessionInformationExtensions) Encode(w *per.Encoder) error {
...
func (s *RedundantPDUSessionInformationExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
