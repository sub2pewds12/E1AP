...
func (s *PDUSessionResourceToSetupList) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceToSetupList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]PDUSessionResourceToSetupItem, length)
