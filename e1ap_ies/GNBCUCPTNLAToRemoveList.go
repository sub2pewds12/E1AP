...
func (s *GNBCUCPTNLAToRemoveList) Encode(w *per.Encoder) (err error) {
...
func (s *GNBCUCPTNLAToRemoveList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]GNBCUCPTNLAToRemoveItem, length)
