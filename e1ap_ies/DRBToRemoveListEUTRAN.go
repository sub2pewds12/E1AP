...
func (s *DRBToRemoveListEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBToRemoveListEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBToRemoveItemEUTRAN, length)
