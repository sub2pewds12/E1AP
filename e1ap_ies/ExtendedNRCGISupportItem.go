...
func (s *ExtendedNRCGISupportItem) Encode(w *aper.AperWriter) (err error) {
...
func (s *ExtendedNRCGISupportItem) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for ExtendedNRCGISupportItem */
	}
	return nil
}
