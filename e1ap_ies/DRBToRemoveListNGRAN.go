...
func (s *DRBToRemoveListNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBToRemoveListNGRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBToRemoveItemNGRAN, length)
