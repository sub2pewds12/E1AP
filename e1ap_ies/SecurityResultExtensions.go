...
// SecurityResultExtensions is a generated type-safe wrapper for extensions.
type SecurityResultExtensions struct {
}

func (s *SecurityResultExtensions) Encode(w *per.Encoder) error {
...
func (s *SecurityResultExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
