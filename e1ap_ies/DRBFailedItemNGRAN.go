...
func (s *DRBFailedItemNGRAN) Encode(w *aper.AperWriter) (err error) {
...
func (s *DRBFailedItemNGRAN) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for DRBFailedItemNGRAN */
	}
	return nil
}
