...
func (s *DRBFailedListNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBFailedListNGRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBFailedItemNGRAN, length)
