...
type DRBFailedItemEUTRAN struct {
	DRBID        DRBID
	Cause        Cause
	IEExtensions *DRBFailedItemEUTRANExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *DRBFailedItemEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBFailedItemEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(2) {
		s.IEExtensions = new(DRBFailedItemEUTRANExtensions)
