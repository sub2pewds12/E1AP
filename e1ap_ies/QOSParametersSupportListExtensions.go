...
// QOSParametersSupportListExtensions is a generated type-safe wrapper for extensions.
type QOSParametersSupportListExtensions struct {
}

func (s *QOSParametersSupportListExtensions) Encode(w *per.Encoder) error {
...
func (s *QOSParametersSupportListExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
