...
// QOSFlowRemovedItemExtensions is a generated type-safe wrapper for extensions.
type QOSFlowRemovedItemExtensions struct {
}

func (s *QOSFlowRemovedItemExtensions) Encode(w *per.Encoder) error {
...
func (s *QOSFlowRemovedItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
