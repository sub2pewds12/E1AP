...
func (s *DRBFailedItemEUTRAN) Encode(w *aper.AperWriter) (err error) {
...
func (s *DRBFailedItemEUTRAN) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for DRBFailedItemEUTRAN */
	}
	return nil
}
