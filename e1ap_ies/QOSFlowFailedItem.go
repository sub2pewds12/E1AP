...
func (s *QOSFlowFailedItem) Encode(w *aper.AperWriter) (err error) {
...
func (s *QOSFlowFailedItem) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for QOSFlowFailedItem */
	}
	return nil
}
