...
// FirstDLCountExtensions is a generated type-safe wrapper for extensions.
type FirstDLCountExtensions struct {
}

func (s *FirstDLCountExtensions) Encode(w *per.Encoder) error {
...
func (s *FirstDLCountExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
