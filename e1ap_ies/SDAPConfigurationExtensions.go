...
// SDAPConfigurationExtensions is a generated type-safe wrapper for extensions.
type SDAPConfigurationExtensions struct {
}

func (s *SDAPConfigurationExtensions) Encode(w *per.Encoder) error {
...
func (s *SDAPConfigurationExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
