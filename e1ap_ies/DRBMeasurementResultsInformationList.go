...
func (s *DRBMeasurementResultsInformationList) Encode(w *per.Encoder) (err error) {
...
func (s *DRBMeasurementResultsInformationList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBMeasurementResultsInformationItem, length)
