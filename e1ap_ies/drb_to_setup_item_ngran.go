...
// DRBToSetupItemNGRAN represents the ASN.1 definition from 9_4_5_Information_Element_Definitions.txt:879
type DRBToSetupItemNGRAN struct {
	...
	QOSFlowInformationToBeSetup         []QOSFlowQOSParameterItem         `asn1:"lb:1,ub:Item,mandatory,ext"`
