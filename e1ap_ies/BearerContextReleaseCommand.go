...
// toIes transforms the BearerContextReleaseCommand struct into a slice of E1APMessageIEs.
...
func (msg *BearerContextReleaseCommand) EncodeWithEncoder(e *per.Encoder) (err error) {
	ies, err := msg.toIes()
	if err != nil {
		return err
	}
...
// Decode implements the MessageUnmarshaller interface for BearerContextReleaseCommand.
func (msg *BearerContextReleaseCommand) Decode(data []byte) (diagList []CriticalityDiagnosticsIEItem, err error) {
	r := per.NewDecoder(data, per.APER)
	return msg.DecodeFromDecoder(r)
}

func (msg *BearerContextReleaseCommand) DecodeFromDecoder(r *per.Decoder) (diagList []CriticalityDiagnosticsIEItem, err error) {

	defer func() {
		if err != nil {
			err = fmt.Errorf("decode BearerContextReleaseCommand failed: %w", err)
		}
	}()
...
func (decoder *BearerContextReleaseCommandDecoder) decodeIE(r *per.Decoder) (msgIe *E1APMessageIE, err error) {
