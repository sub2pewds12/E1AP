...
func (s *EUTRANQOSSupportItem) Encode(w *aper.AperWriter) (err error) {
...
func (s *EUTRANQOSSupportItem) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for EUTRANQOSSupportItem */
	}
	return nil
}
