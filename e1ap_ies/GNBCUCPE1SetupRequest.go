...
func (msg *GNBCUCPE1SetupRequest) toIes() ([]E1APMessageIE, error) {
	...
	if msg.GNBCUCPName != nil {
		...
		ies = append(ies, E1APMessageIE{
			Id:          ProtocolIEID(ProtocolIEIDGNBCUCPName),
	...
	if msg.ExtendedGNBCUCPName != nil {
		...
		ies = append(ies, E1APMessageIE{
			Id:          ProtocolIEID(ProtocolIEIDExtendedGNBCUCPName),
			Criticality: Criticality{Value: CriticalityIgnore},
...
// Encode for GNBCUCPE1SetupRequest: Could not find associated procedure.
