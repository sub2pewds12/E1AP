...
func (s *UEAssociatedLogicalE1ConnectionItem) Encode(w *aper.AperWriter) (err error) {
...
func (s *UEAssociatedLogicalE1ConnectionItem) Decode(r *aper.AperReader) (err error) {
