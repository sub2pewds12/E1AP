...
func (s *DRBActivityItem) Encode(w *aper.AperWriter) (err error) {
...
func (s *DRBActivityItem) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for DRBActivityItem */
	}
	return nil
}
