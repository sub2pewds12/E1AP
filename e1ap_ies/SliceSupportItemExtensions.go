...
// SliceSupportItemExtensions is a generated type-safe wrapper for extensions.
type SliceSupportItemExtensions struct {
}

func (s *SliceSupportItemExtensions) Encode(w *per.Encoder) error {
...
func (s *SliceSupportItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
