...
type QOSFlowMappingItem struct {
	...
	IEExtensions             *QOSFlowMappingItemExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *QOSFlowMappingItem) Encode(w *per.Encoder) (err error) {
...
func (s *QOSFlowMappingItem) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(2) {
		s.IEExtensions = new(QOSFlowMappingItemExtensions)
