...
type DRBRequiredToRemoveItemEUTRAN struct {
	DRBID        DRBID
	Cause        Cause
	IEExtensions *DRBRequiredToRemoveItemEUTRANExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *DRBRequiredToRemoveItemEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBRequiredToRemoveItemEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(2) {
		s.IEExtensions = new(DRBRequiredToRemoveItemEUTRANExtensions)
