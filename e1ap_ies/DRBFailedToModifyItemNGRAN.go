...
// DRBFailedToModifyItemNGRAN is a generated SEQUENCE type.
type DRBFailedToModifyItemNGRAN struct {
	DRBID        DRBID
	Cause        Cause
	IEExtensions *DRBFailedToModifyItemNGRANExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *DRBFailedToModifyItemNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBFailedToModifyItemNGRAN) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(2) {
		s.IEExtensions = new(DRBFailedToModifyItemNGRANExtensions)
