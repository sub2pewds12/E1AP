...
// DRBStatusItemExtensions is a generated type-safe wrapper for extensions.
type DRBStatusItemExtensions struct {
}

func (s *DRBStatusItemExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBStatusItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
