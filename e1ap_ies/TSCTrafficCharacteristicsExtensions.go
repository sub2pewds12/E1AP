...
// TSCTrafficCharacteristicsExtensions is a generated type-safe wrapper for extensions.
type TSCTrafficCharacteristicsExtensions struct {
}

func (s *TSCTrafficCharacteristicsExtensions) Encode(w *per.Encoder) error {
...
func (s *TSCTrafficCharacteristicsExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
