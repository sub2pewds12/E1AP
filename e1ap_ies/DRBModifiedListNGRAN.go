...
func (s *DRBModifiedListNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBModifiedListNGRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBModifiedItemNGRAN, length)
