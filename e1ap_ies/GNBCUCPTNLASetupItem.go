...
type GNBCUCPTNLASetupItem struct {
	...
	IEExtensions                        *GNBCUCPTNLASetupItemExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *GNBCUCPTNLASetupItem) Encode(w *per.Encoder) (err error) {
...
func (s *GNBCUCPTNLASetupItem) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(1) {
		s.IEExtensions = new(GNBCUCPTNLASetupItemExtensions)
