...
// DRBToSetupItemEUTRANExtensions is a generated type-safe wrapper for extensions.
type DRBToSetupItemEUTRANExtensions struct {
}

func (s *DRBToSetupItemEUTRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBToSetupItemEUTRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
