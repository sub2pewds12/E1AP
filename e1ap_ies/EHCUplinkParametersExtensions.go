...
// EHCUplinkParametersExtensions is a generated type-safe wrapper for extensions.
type EHCUplinkParametersExtensions struct {
}

func (s *EHCUplinkParametersExtensions) Encode(w *per.Encoder) error {
...
func (s *EHCUplinkParametersExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
