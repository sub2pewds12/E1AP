...
func (s *QOSFlowMappingList) Encode(w *per.Encoder) (err error) {
...
func (s *QOSFlowMappingList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]QOSFlowMappingItem, length)
