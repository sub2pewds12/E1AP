...
// MRDCDataUsageReportItemExtensions is a generated type-safe wrapper for extensions.
type MRDCDataUsageReportItemExtensions struct {
}

func (s *MRDCDataUsageReportItemExtensions) Encode(w *per.Encoder) error {
...
func (s *MRDCDataUsageReportItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
