...
func (s *PDUSessionResourceRequiredToModifyItemExtensions) Encode(w *per.Encoder) error {
...
func (s *PDUSessionResourceRequiredToModifyItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
