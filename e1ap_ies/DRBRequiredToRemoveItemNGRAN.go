...
func (s *DRBRequiredToRemoveItemNGRAN) Encode(w *aper.AperWriter) (err error) {
...
func (s *DRBRequiredToRemoveItemNGRAN) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for DRBRequiredToRemoveItemNGRAN */
	}
	return nil
}
