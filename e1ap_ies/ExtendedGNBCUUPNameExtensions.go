...
// ExtendedGNBCUUPNameExtensions is a generated type-safe wrapper for extensions.
type ExtendedGNBCUUPNameExtensions struct {
}

func (s *ExtendedGNBCUUPNameExtensions) Encode(w *per.Encoder) error {
...
func (s *ExtendedGNBCUUPNameExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
