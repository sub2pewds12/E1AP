...
type NRCGISupportItem struct {
	NRCGI        NRCGI
	IEExtensions *NRCGISupportItemExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *NRCGISupportItem) Encode(w *per.Encoder) (err error) {
...
func (s *NRCGISupportItem) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(1) {
		s.IEExtensions = new(NRCGISupportItemExtensions)
