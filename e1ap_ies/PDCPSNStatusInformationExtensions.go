...
// PDCPSNStatusInformationExtensions is a generated type-safe wrapper for extensions.
type PDCPSNStatusInformationExtensions struct {
}

func (s *PDCPSNStatusInformationExtensions) Encode(w *per.Encoder) error {
...
func (s *PDCPSNStatusInformationExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
