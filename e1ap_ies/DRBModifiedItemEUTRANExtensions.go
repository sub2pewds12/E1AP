...
// DRBModifiedItemEUTRANExtensions is a generated type-safe wrapper for extensions.
type DRBModifiedItemEUTRANExtensions struct {
}

func (s *DRBModifiedItemEUTRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBModifiedItemEUTRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
