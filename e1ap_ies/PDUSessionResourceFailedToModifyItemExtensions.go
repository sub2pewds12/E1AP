...
// PDUSessionResourceFailedToModifyItemExtensions is a generated type-safe wrapper for extensions.
type PDUSessionResourceFailedToModifyItemExtensions struct {
}

func (s *PDUSessionResourceFailedToModifyItemExtensions) Encode(w *per.Encoder) error {
...
func (s *PDUSessionResourceFailedToModifyItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
