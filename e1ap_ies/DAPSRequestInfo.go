...
func (s *DAPSRequestInfo) Encode(w *aper.AperWriter) (err error) {
...
func (s *DAPSRequestInfo) Decode(r *aper.AperReader) (err error) {
...

	{
		...
		s.DapsIndicator.Value = aper.Enumerated(val)
	}
	...
	if isExtensible {
		return fmt.Errorf("Extensions not yet implemented for DAPSRequestInfo")
	}
	return nil
}
