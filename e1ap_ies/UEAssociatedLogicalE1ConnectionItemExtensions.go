...
// UEAssociatedLogicalE1ConnectionItemExtensions is a generated type-safe wrapper for extensions.
type UEAssociatedLogicalE1ConnectionItemExtensions struct {
}

func (s *UEAssociatedLogicalE1ConnectionItemExtensions) Encode(w *per.Encoder) error {
...
func (s *UEAssociatedLogicalE1ConnectionItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
