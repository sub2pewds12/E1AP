...
func (s *DRBToSetupListNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBToSetupListNGRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBToSetupItemNGRAN, length)
