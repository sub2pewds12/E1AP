...
func (s *PDUSessionResourceFailedToModifyList) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceFailedToModifyList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]PDUSessionResourceFailedToModifyItem, length)
