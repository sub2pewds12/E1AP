...
func (s *DRBFailedModItemEUTRAN) Encode(w *aper.AperWriter) (err error) {
...
func (s *DRBFailedModItemEUTRAN) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for DRBFailedModItemEUTRAN */
	}
	return nil
}
