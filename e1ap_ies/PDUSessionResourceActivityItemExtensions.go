...
// PDUSessionResourceActivityItemExtensions is a generated type-safe wrapper for extensions.
type PDUSessionResourceActivityItemExtensions struct {
}

func (s *PDUSessionResourceActivityItemExtensions) Encode(w *per.Encoder) error {
...
func (s *PDUSessionResourceActivityItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
