...
func (msg *BearerContextSetupResponse) toIes() ([]E1APMessageIE, error) {
	...
	ies = append(ies, E1APMessageIE{
		ID:          ProtocolIEID{Value: ProtocolIEIDSystemBearerContextSetupResponse},
...
func (msg *BearerContextSetupResponse) EncodeWithEncoder(e *per.Encoder) (err error) {
	ies, err := msg.toIes()
	if err != nil {
		return err
	}
...
// Decode implements the MessageUnmarshaller interface for BearerContextSetupResponse.
func (msg *BearerContextSetupResponse) Decode(data []byte) (diagList []CriticalityDiagnosticsIEItem, err error) {
	r := per.NewDecoder(data, per.APER)
	return msg.DecodeFromDecoder(r)
}

func (msg *BearerContextSetupResponse) DecodeFromDecoder(r *per.Decoder) (diagList []CriticalityDiagnosticsIEItem, err error) {

	defer func() {
		if err != nil {
			err = fmt.Errorf("decode BearerContextSetupResponse failed: %w", err)
		}
	}()
...
func (decoder *BearerContextSetupResponseDecoder) decodeIE(r *per.Decoder) (msgIe *E1APMessageIE, err error) {
