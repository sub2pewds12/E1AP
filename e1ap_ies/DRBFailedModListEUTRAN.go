...
func (s *DRBFailedModListEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBFailedModListEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBFailedModItemEUTRAN, length)
