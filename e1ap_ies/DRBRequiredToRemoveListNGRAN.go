...
func (s *DRBRequiredToRemoveListNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBRequiredToRemoveListNGRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBRequiredToRemoveItemNGRAN, length)
