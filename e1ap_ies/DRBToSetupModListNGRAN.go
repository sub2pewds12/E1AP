...
func (s *DRBToSetupModListNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBToSetupModListNGRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBToSetupModItemNGRAN, length)
