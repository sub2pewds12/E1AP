...
func (s *DRBRequiredToModifyListEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBRequiredToModifyListEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBRequiredToModifyItemEUTRAN, length)
