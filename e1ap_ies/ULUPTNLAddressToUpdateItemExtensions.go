...
// ULUPTNLAddressToUpdateItemExtensions is a generated type-safe wrapper for extensions.
type ULUPTNLAddressToUpdateItemExtensions struct {
}

func (s *ULUPTNLAddressToUpdateItemExtensions) Encode(w *per.Encoder) error {
...
func (s *ULUPTNLAddressToUpdateItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
