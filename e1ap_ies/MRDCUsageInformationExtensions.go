...
// MRDCUsageInformationExtensions is a generated type-safe wrapper for extensions.
type MRDCUsageInformationExtensions struct {
}

func (s *MRDCUsageInformationExtensions) Encode(w *per.Encoder) error {
...
func (s *MRDCUsageInformationExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
