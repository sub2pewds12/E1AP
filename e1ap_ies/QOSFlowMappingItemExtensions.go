...
// QOSFlowMappingItemExtensions is a generated type-safe wrapper for extensions.
type QOSFlowMappingItemExtensions struct {
}

func (s *QOSFlowMappingItemExtensions) Encode(w *per.Encoder) error {
...
func (s *QOSFlowMappingItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
