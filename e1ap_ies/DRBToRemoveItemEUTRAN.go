...
type DRBToRemoveItemEUTRAN struct {
	DRBID        DRBID
	IEExtensions *DRBToRemoveItemEUTRANExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *DRBToRemoveItemEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBToRemoveItemEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(1) {
		s.IEExtensions = new(DRBToRemoveItemEUTRANExtensions)
