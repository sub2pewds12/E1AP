...
type PDUSessionResourceFailedModItem struct {
	...
	Cause        Cause
	IEExtensions *PDUSessionResourceFailedModItemExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *PDUSessionResourceFailedModItem) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceFailedModItem) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(2) {
		s.IEExtensions = new(PDUSessionResourceFailedModItemExtensions)
