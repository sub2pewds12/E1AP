...
// GNBCUUPCellGroupRelatedConfigurationItemExtensions is a generated type-safe wrapper for extensions.
type GNBCUUPCellGroupRelatedConfigurationItemExtensions struct {
}

func (s *GNBCUUPCellGroupRelatedConfigurationItemExtensions) Encode(w *per.Encoder) error {
...
func (s *GNBCUUPCellGroupRelatedConfigurationItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
