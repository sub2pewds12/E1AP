...
func (s *DRBFailedToModifyListEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBFailedToModifyListEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBFailedToModifyItemEUTRAN, length)
