...
// DRBSetupModItemNGRANExtensions is a generated type-safe wrapper for extensions.
type DRBSetupModItemNGRANExtensions struct {
}

func (s *DRBSetupModItemNGRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBSetupModItemNGRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
