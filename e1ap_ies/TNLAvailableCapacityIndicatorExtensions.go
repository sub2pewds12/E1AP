...
// TNLAvailableCapacityIndicatorExtensions is a generated type-safe wrapper for extensions.
type TNLAvailableCapacityIndicatorExtensions struct {
}

func (s *TNLAvailableCapacityIndicatorExtensions) Encode(w *per.Encoder) error {
...
func (s *TNLAvailableCapacityIndicatorExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
