...
func (s *SliceSupportItem) Encode(w *aper.AperWriter) (err error) {
...
func (s *SliceSupportItem) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for SliceSupportItem */
	}
	return nil
}
