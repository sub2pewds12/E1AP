...
// GBRQosInformationExtensions is a generated type-safe wrapper for extensions.
type GBRQosInformationExtensions struct {
}

func (s *GBRQosInformationExtensions) Encode(w *per.Encoder) error {
...
func (s *GBRQosInformationExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
