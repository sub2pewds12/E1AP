...
// DataForwardingtoEUTRANInformationListItemExtensions is a generated type-safe wrapper for extensions.
type DataForwardingtoEUTRANInformationListItemExtensions struct {
}

func (s *DataForwardingtoEUTRANInformationListItemExtensions) Encode(w *per.Encoder) error {
...
func (s *DataForwardingtoEUTRANInformationListItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
