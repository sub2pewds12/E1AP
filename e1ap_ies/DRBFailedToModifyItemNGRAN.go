...
func (s *DRBFailedToModifyItemNGRAN) Encode(w *aper.AperWriter) (err error) {
...
func (s *DRBFailedToModifyItemNGRAN) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for DRBFailedToModifyItemNGRAN */
	}
	return nil
}
