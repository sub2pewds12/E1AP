...
// GTPTunnelExtensions is a generated type-safe wrapper for extensions.
type GTPTunnelExtensions struct {
}

func (s *GTPTunnelExtensions) Encode(w *per.Encoder) error {
...
func (s *GTPTunnelExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
