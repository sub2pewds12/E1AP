...
// SecurityIndicationExtensions is a generated type-safe wrapper for extensions.
type SecurityIndicationExtensions struct {
}

func (s *SecurityIndicationExtensions) Encode(w *per.Encoder) error {
...
func (s *SecurityIndicationExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
