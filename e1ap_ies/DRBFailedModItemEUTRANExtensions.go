...
// DRBFailedModItemEUTRANExtensions is a generated type-safe wrapper for extensions.
type DRBFailedModItemEUTRANExtensions struct {
}

func (s *DRBFailedModItemEUTRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBFailedModItemEUTRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
