...
func (s *PDUSessionResourceToModifyList) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceToModifyList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]PDUSessionResourceToModifyItem, length)
