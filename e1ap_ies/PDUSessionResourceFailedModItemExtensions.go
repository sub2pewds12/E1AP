...
// PDUSessionResourceFailedModItemExtensions is a generated type-safe wrapper for extensions.
type PDUSessionResourceFailedModItemExtensions struct {
}

func (s *PDUSessionResourceFailedModItemExtensions) Encode(w *per.Encoder) error {
...
func (s *PDUSessionResourceFailedModItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
