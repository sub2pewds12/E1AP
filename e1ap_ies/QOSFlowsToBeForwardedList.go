...
func (s *QOSFlowsToBeForwardedList) Encode(w *per.Encoder) (err error) {
...
func (s *QOSFlowsToBeForwardedList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]QOSFlowsToBeForwardedItem, length)
