...
func (s *DRBRequiredToModifyItemEUTRAN) Encode(w *aper.AperWriter) (err error) {
...
func (s *DRBRequiredToModifyItemEUTRAN) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for DRBRequiredToModifyItemEUTRAN */
	}
	return nil
}
