...
// UplinkOnlyROHCExtensions is a generated type-safe wrapper for extensions.
type UplinkOnlyROHCExtensions struct {
}

func (s *UplinkOnlyROHCExtensions) Encode(w *per.Encoder) error {
...
func (s *UplinkOnlyROHCExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
