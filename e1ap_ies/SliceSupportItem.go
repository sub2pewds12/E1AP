...
type SliceSupportItem struct {
	SNSSAI       SNSSAI
	IEExtensions *SliceSupportItemExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *SliceSupportItem) Encode(w *per.Encoder) (err error) {
...
func (s *SliceSupportItem) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(1) {
		s.IEExtensions = new(SliceSupportItemExtensions)
