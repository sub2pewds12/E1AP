...
// M6ConfigurationExtensions is a generated type-safe wrapper for extensions.
type M6ConfigurationExtensions struct {
}

func (s *M6ConfigurationExtensions) Encode(w *per.Encoder) error {
...
func (s *M6ConfigurationExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
