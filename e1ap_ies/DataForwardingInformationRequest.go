...
type DataForwardingInformationRequest struct {
	...
	QOSFlowsForwardedOnFwdTunnels *QOSFlowMappingList         `aper:"optional,ext"`
...
func (s *DataForwardingInformationRequest) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible {
		return fmt.Errorf("Extensions not yet implemented for DataForwardingInformationRequest")
	}
	return nil
}
