...
// QOSFlowsToBeForwardedItemExtensions is a generated type-safe wrapper for extensions.
type QOSFlowsToBeForwardedItemExtensions struct {
}

func (s *QOSFlowsToBeForwardedItemExtensions) Encode(w *per.Encoder) error {
...
func (s *QOSFlowsToBeForwardedItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
