...
// DRBSetupItemEUTRANExtensions is a generated type-safe wrapper for extensions.
type DRBSetupItemEUTRANExtensions struct {
}

func (s *DRBSetupItemEUTRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBSetupItemEUTRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
