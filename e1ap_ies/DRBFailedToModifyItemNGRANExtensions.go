...
// DRBFailedToModifyItemNGRANExtensions is a generated type-safe wrapper for extensions.
type DRBFailedToModifyItemNGRANExtensions struct {
}

func (s *DRBFailedToModifyItemNGRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBFailedToModifyItemNGRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
