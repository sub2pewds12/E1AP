...
// SecurityAlgorithmExtensions is a generated type-safe wrapper for extensions.
type SecurityAlgorithmExtensions struct {
}

func (s *SecurityAlgorithmExtensions) Encode(w *per.Encoder) error {
...
func (s *SecurityAlgorithmExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
