...
// DRBsSubjectToCounterCheckItemNGRANExtensions is a generated type-safe wrapper for extensions.
type DRBsSubjectToCounterCheckItemNGRANExtensions struct {
}

func (s *DRBsSubjectToCounterCheckItemNGRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBsSubjectToCounterCheckItemNGRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
