...
// CriticalityDiagnosticsIEItemExtensions is a generated type-safe wrapper for extensions.
type CriticalityDiagnosticsIEItemExtensions struct {
}

func (s *CriticalityDiagnosticsIEItemExtensions) Encode(w *per.Encoder) error {
...
func (s *CriticalityDiagnosticsIEItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
