...
func (s *DRBFailedToModifyItemEUTRAN) Encode(w *aper.AperWriter) (err error) {
...
func (s *DRBFailedToModifyItemEUTRAN) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for DRBFailedToModifyItemEUTRAN */
	}
	return nil
}
