...
func (msg *BearerContextModificationResponse) toIes() ([]E1APMessageIE, error) {
	...
	if msg.SystemBearerContextModificationResponse != nil {
		...
		ies = append(ies, E1APMessageIE{
			Id:          ProtocolIEID(ProtocolIEIDSystemBearerContextModificationResponse),
...
func (msg *BearerContextModificationResponse) Encode(w io.Writer) error {
	...
	return encodeMessage(w, E1apPduSuccessfulOutcome, ProcedureCodeBearerContextModification, Criticality{Value: CriticalityIgnore}, ies)
}
