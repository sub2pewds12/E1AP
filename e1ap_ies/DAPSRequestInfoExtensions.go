...
// DAPSRequestInfoExtensions is a generated type-safe wrapper for extensions.
type DAPSRequestInfoExtensions struct {
}

func (s *DAPSRequestInfoExtensions) Encode(w *per.Encoder) error {
...
func (s *DAPSRequestInfoExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
