...
// QOSFlowFailedItemExtensions is a generated type-safe wrapper for extensions.
type QOSFlowFailedItemExtensions struct {
}

func (s *QOSFlowFailedItemExtensions) Encode(w *per.Encoder) error {
...
func (s *QOSFlowFailedItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
