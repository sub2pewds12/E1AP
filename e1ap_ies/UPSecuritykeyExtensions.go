...
// UPSecuritykeyExtensions is a generated type-safe wrapper for extensions.
type UPSecuritykeyExtensions struct {
}

func (s *UPSecuritykeyExtensions) Encode(w *per.Encoder) error {
...
func (s *UPSecuritykeyExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
