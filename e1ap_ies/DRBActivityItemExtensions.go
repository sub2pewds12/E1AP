...
// DRBActivityItemExtensions is a generated type-safe wrapper for extensions.
type DRBActivityItemExtensions struct {
}

func (s *DRBActivityItemExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBActivityItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
