...
// DataForwardingInformationRequestExtensions is a generated type-safe wrapper for extensions.
type DataForwardingInformationRequestExtensions struct {
}

func (s *DataForwardingInformationRequestExtensions) Encode(w *per.Encoder) error {
...
func (s *DataForwardingInformationRequestExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
