...
// NPNContextInfoSNPNExtensions is a generated type-safe wrapper for extensions.
type NPNContextInfoSNPNExtensions struct {
}

func (s *NPNContextInfoSNPNExtensions) Encode(w *per.Encoder) error {
...
func (s *NPNContextInfoSNPNExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
