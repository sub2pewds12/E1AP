...
func (s *PDUSessionResourceFailedModList) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceFailedModList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]PDUSessionResourceFailedModItem, length)
