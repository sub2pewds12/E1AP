...
func (s *QOSFlowQOSParameterList) Encode(w *per.Encoder) (err error) {
...
func (s *QOSFlowQOSParameterList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]QOSFlowQOSParameterItem, length)
