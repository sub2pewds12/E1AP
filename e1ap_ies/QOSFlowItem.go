...
type QOSFlowItem struct {
	...
	IEExtensions      *QOSFlowItemExtensions `aper:"optional,ext"`
}

// Encode implements the aper.AperMarshaller interface.
func (s *QOSFlowItem) Encode(w *aper.AperWriter) (err error) {
...
func (s *QOSFlowItem) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for QOSFlowItem */
	}
	return nil
}
