...
func (s *EHCUplinkParameters) Encode(w *aper.AperWriter) (err error) {
...
func (s *EHCUplinkParameters) Decode(r *aper.AperReader) (err error) {
...

	{
		...
		s.DRBContinueEHCUL.Value = aper.Enumerated(val)
	}
	...
	if isExtensible {
		return fmt.Errorf("Extensions not yet implemented for EHCUplinkParameters")
	}
	return nil
}
