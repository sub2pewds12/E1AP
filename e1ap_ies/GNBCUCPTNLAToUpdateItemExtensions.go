...
// GNBCUCPTNLAToUpdateItemExtensions is a generated type-safe wrapper for extensions.
type GNBCUCPTNLAToUpdateItemExtensions struct {
}

func (s *GNBCUCPTNLAToUpdateItemExtensions) Encode(w *per.Encoder) error {
...
func (s *GNBCUCPTNLAToUpdateItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
