...
// ExtendedNRCGISupportItemExtensions is a generated type-safe wrapper for extensions.
type ExtendedNRCGISupportItemExtensions struct {
}

func (s *ExtendedNRCGISupportItemExtensions) Encode(w *per.Encoder) error {
...
func (s *ExtendedNRCGISupportItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
