...
func (s *DRBsSubjectToCounterCheckListEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBsSubjectToCounterCheckListEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBsSubjectToCounterCheckItemEUTRAN, length)
