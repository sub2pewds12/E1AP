...
// toIes transforms the GNBCUUPConfigurationUpdateFailure struct into a slice of E1APMessageIEs.
...
func (msg *GNBCUUPConfigurationUpdateFailure) EncodeWithEncoder(e *per.Encoder) (err error) {
	ies, err := msg.toIes()
	if err != nil {
		return err
	}
...
func (msg *GNBCUUPConfigurationUpdateFailure) Encode(w io.Writer) error {
...
// Decode implements the MessageUnmarshaller interface for GNBCUUPConfigurationUpdateFailure.
func (msg *GNBCUUPConfigurationUpdateFailure) Decode(data []byte) (diagList []CriticalityDiagnosticsIEItem, err error) {
	r := per.NewDecoder(data, per.APER)
	return msg.DecodeFromDecoder(r)
}

func (msg *GNBCUUPConfigurationUpdateFailure) DecodeFromDecoder(r *per.Decoder) (diagList []CriticalityDiagnosticsIEItem, err error) {

	defer func() {
		if err != nil {
			err = fmt.Errorf("decode GNBCUUPConfigurationUpdateFailure failed: %w", err)
		}
	}()
...
func (decoder *GNBCUUPConfigurationUpdateFailureDecoder) decodeIE(r *per.Decoder) (msgIe *E1APMessageIE, err error) {
