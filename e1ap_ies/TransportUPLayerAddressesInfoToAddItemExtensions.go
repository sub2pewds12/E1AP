...
// TransportUPLayerAddressesInfoToAddItemExtensions is a generated type-safe wrapper for extensions.
type TransportUPLayerAddressesInfoToAddItemExtensions struct {
}

func (s *TransportUPLayerAddressesInfoToAddItemExtensions) Encode(w *per.Encoder) error {
...
func (s *TransportUPLayerAddressesInfoToAddItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
