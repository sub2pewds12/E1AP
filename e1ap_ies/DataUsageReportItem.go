...
func (s *DataUsageReportItem) Encode(w *aper.AperWriter) (err error) {
...
func (s *DataUsageReportItem) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for DataUsageReportItem */
	}
	return nil
}
