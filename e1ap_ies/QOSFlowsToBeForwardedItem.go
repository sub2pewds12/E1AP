...
type QOSFlowsToBeForwardedItem struct {
	...
	IEExtensions      *QOSFlowsToBeForwardedItemExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *QOSFlowsToBeForwardedItem) Encode(w *per.Encoder) (err error) {
...
func (s *QOSFlowsToBeForwardedItem) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(1) {
		s.IEExtensions = new(QOSFlowsToBeForwardedItemExtensions)
