...
// GTPTLAItemExtensions is a generated type-safe wrapper for extensions.
type GTPTLAItemExtensions struct {
}

func (s *GTPTLAItemExtensions) Encode(w *per.Encoder) error {
...
func (s *GTPTLAItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
