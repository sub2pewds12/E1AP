...
// ExtendedGNBCUCPNameExtensions is a generated type-safe wrapper for extensions.
type ExtendedGNBCUCPNameExtensions struct {
}

func (s *ExtendedGNBCUCPNameExtensions) Encode(w *per.Encoder) error {
...
func (s *ExtendedGNBCUCPNameExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
