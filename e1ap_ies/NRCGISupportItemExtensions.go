...
// NRCGISupportItemExtensions is a generated type-safe wrapper for extensions.
type NRCGISupportItemExtensions struct {
}

func (s *NRCGISupportItemExtensions) Encode(w *per.Encoder) error {
...
func (s *NRCGISupportItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
