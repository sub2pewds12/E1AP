...
// PDUSessionResourceDataUsageItemExtensions is a generated type-safe wrapper for extensions.
type PDUSessionResourceDataUsageItemExtensions struct {
}

func (s *PDUSessionResourceDataUsageItemExtensions) Encode(w *per.Encoder) error {
...
func (s *PDUSessionResourceDataUsageItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
