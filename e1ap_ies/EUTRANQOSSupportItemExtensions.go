...
// EUTRANQOSSupportItemExtensions is a generated type-safe wrapper for extensions.
type EUTRANQOSSupportItemExtensions struct {
}

func (s *EUTRANQOSSupportItemExtensions) Encode(w *per.Encoder) error {
...
func (s *EUTRANQOSSupportItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
