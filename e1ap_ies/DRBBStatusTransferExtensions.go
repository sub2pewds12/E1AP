...
// DRBBStatusTransferExtensions is a generated type-safe wrapper for extensions.
type DRBBStatusTransferExtensions struct {
}

func (s *DRBBStatusTransferExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBBStatusTransferExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
