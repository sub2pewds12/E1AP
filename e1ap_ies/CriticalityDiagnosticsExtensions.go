...
// CriticalityDiagnosticsExtensions is a generated type-safe wrapper for extensions.
type CriticalityDiagnosticsExtensions struct {
}

func (s *CriticalityDiagnosticsExtensions) Encode(w *per.Encoder) error {
...
func (s *CriticalityDiagnosticsExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
