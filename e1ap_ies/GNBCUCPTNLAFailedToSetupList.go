...
func (s *GNBCUCPTNLAFailedToSetupList) Encode(w *per.Encoder) (err error) {
...
func (s *GNBCUCPTNLAFailedToSetupList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]GNBCUCPTNLAFailedToSetupItem, length)
