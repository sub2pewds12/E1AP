...
// DRBFailedItemEUTRANExtensions is a generated type-safe wrapper for extensions.
type DRBFailedItemEUTRANExtensions struct {
}

func (s *DRBFailedItemEUTRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBFailedItemEUTRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
