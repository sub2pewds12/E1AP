...
type PDUSessionResourceFailedItem struct {
	...
	Cause        Cause
	IEExtensions *PDUSessionResourceFailedItemExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *PDUSessionResourceFailedItem) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceFailedItem) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(2) {
		s.IEExtensions = new(PDUSessionResourceFailedItemExtensions)
