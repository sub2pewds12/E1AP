...
func (s *PDUSessionResourceToRemoveList) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceToRemoveList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]PDUSessionResourceToRemoveItem, length)
