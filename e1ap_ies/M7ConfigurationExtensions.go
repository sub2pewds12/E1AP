...
// M7ConfigurationExtensions is a generated type-safe wrapper for extensions.
type M7ConfigurationExtensions struct {
}

func (s *M7ConfigurationExtensions) Encode(w *per.Encoder) error {
...
func (s *M7ConfigurationExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
