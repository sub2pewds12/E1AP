...
func (s *DRBRequiredToRemoveItemEUTRAN) Encode(w *aper.AperWriter) (err error) {
...
func (s *DRBRequiredToRemoveItemEUTRAN) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible { /* TODO: Implement extension skipping for DRBRequiredToRemoveItemEUTRAN */
	}
	return nil
}
