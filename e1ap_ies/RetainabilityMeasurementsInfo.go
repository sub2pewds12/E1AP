...
func (s *RetainabilityMeasurementsInfo) Encode(w *per.Encoder) (err error) {
...
func (s *RetainabilityMeasurementsInfo) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBRemovedItem, length)
