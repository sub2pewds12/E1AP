...
func (s *NonDynamic5QIDescriptorExtensions) Encode(w *aper.AperWriter) error {
	...
	return fmt.Errorf("Encode not yet implemented for NonDynamic5QIDescriptorExtensions")
}
...
func (s *NonDynamic5QIDescriptorExtensions) Decode(r *aper.AperReader) error {
	...
	return fmt.Errorf("Decode not yet implemented for NonDynamic5QIDescriptorExtensions")
}
