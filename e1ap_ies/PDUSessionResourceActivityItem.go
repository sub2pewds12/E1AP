...
func (s *PDUSessionResourceActivityItem) Encode(w *aper.AperWriter) (err error) {
...
func (s *PDUSessionResourceActivityItem) Decode(r *aper.AperReader) (err error) {
...

	{
		...
		s.PDUSessionResourceActivity.Value = aper.Enumerated(val)
	}
	...
	if isExtensible {
		return fmt.Errorf("Extensions not yet implemented for PDUSessionResourceActivityItem")
	}
	return nil
}
