...
func (s *TransportUPLayerAddressesInfoToRemoveList) Encode(w *per.Encoder) (err error) {
...
func (s *TransportUPLayerAddressesInfoToRemoveList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]TransportUPLayerAddressesInfoToRemoveItem, length)
