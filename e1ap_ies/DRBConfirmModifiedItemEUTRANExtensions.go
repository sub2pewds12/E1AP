...
// DRBConfirmModifiedItemEUTRANExtensions is a generated type-safe wrapper for extensions.
type DRBConfirmModifiedItemEUTRANExtensions struct {
}

func (s *DRBConfirmModifiedItemEUTRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBConfirmModifiedItemEUTRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
