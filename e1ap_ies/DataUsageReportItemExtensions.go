...
// DataUsageReportItemExtensions is a generated type-safe wrapper for extensions.
type DataUsageReportItemExtensions struct {
}

func (s *DataUsageReportItemExtensions) Encode(w *per.Encoder) error {
...
func (s *DataUsageReportItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
