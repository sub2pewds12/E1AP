...
func (s *GNBCUUPTNLAToRemoveList) Encode(w *per.Encoder) (err error) {
...
func (s *GNBCUUPTNLAToRemoveList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]GNBCUUPTNLAToRemoveItem, length)
