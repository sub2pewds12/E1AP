...
func (s *DLUPTNLAddressToUpdateList) Encode(w *per.Encoder) (err error) {
...
func (s *DLUPTNLAddressToUpdateList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DLUPTNLAddressToUpdateItem, length)
