...
func (s *GNBCUCPTNLASetupList) Encode(w *per.Encoder) (err error) {
...
func (s *GNBCUCPTNLASetupList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]GNBCUCPTNLASetupItem, length)
