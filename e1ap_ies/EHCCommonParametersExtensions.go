...
// EHCCommonParametersExtensions is a generated type-safe wrapper for extensions.
type EHCCommonParametersExtensions struct {
}

func (s *EHCCommonParametersExtensions) Encode(w *per.Encoder) error {
...
func (s *EHCCommonParametersExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
