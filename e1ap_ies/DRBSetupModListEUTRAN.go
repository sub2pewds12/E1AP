...
func (s *DRBSetupModListEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBSetupModListEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBSetupModItemEUTRAN, length)
