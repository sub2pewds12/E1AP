...
// GNBCUUPTNLAToRemoveItemExtensions is a generated type-safe wrapper for extensions.
type GNBCUUPTNLAToRemoveItemExtensions struct {
}

func (s *GNBCUUPTNLAToRemoveItemExtensions) Encode(w *per.Encoder) error {
...
func (s *GNBCUUPTNLAToRemoveItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
