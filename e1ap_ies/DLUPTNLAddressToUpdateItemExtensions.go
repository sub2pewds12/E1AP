...
// DLUPTNLAddressToUpdateItemExtensions is a generated type-safe wrapper for extensions.
type DLUPTNLAddressToUpdateItemExtensions struct {
}

func (s *DLUPTNLAddressToUpdateItemExtensions) Encode(w *per.Encoder) error {
...
func (s *DLUPTNLAddressToUpdateItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
