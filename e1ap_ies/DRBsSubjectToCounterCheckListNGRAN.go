...
func (s *DRBsSubjectToCounterCheckListNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBsSubjectToCounterCheckListNGRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBsSubjectToCounterCheckItemNGRAN, length)
