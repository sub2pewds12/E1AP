...
// DRBToModifyItemEUTRANExtensions is a generated type-safe wrapper for extensions.
type DRBToModifyItemEUTRANExtensions struct {
}

func (s *DRBToModifyItemEUTRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBToModifyItemEUTRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
