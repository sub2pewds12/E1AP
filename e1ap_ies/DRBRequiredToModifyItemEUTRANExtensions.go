...
// DRBRequiredToModifyItemEUTRANExtensions is a generated type-safe wrapper for extensions.
type DRBRequiredToModifyItemEUTRANExtensions struct {
}

func (s *DRBRequiredToModifyItemEUTRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBRequiredToModifyItemEUTRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
