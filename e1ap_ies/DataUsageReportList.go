...
func (s *DataUsageReportList) Encode(w *per.Encoder) (err error) {
...
func (s *DataUsageReportList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DataUsageReportItem, length)
