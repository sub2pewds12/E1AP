...
// EUTRANAllocationAndRetentionPriorityExtensions is a generated type-safe wrapper for extensions.
type EUTRANAllocationAndRetentionPriorityExtensions struct {
}

func (s *EUTRANAllocationAndRetentionPriorityExtensions) Encode(w *per.Encoder) error {
...
func (s *EUTRANAllocationAndRetentionPriorityExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
