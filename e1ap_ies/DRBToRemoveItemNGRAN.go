...
type DRBToRemoveItemNGRAN struct {
	DRBID        DRBID
	IEExtensions *DRBToRemoveItemNGRANExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *DRBToRemoveItemNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBToRemoveItemNGRAN) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(1) {
		s.IEExtensions = new(DRBToRemoveItemNGRANExtensions)
