...
// TransportUPLayerAddressesInfoToRemoveItemExtensions is a generated type-safe wrapper for extensions.
type TransportUPLayerAddressesInfoToRemoveItemExtensions struct {
}

func (s *TransportUPLayerAddressesInfoToRemoveItemExtensions) Encode(w *per.Encoder) error {
...
func (s *TransportUPLayerAddressesInfoToRemoveItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
