...
// M4ConfigurationExtensions is a generated type-safe wrapper for extensions.
type M4ConfigurationExtensions struct {
}

func (s *M4ConfigurationExtensions) Encode(w *per.Encoder) error {
...
func (s *M4ConfigurationExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
