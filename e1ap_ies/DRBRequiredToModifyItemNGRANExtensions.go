...
// DRBRequiredToModifyItemNGRANExtensions is a generated type-safe wrapper for extensions.
type DRBRequiredToModifyItemNGRANExtensions struct {
}

func (s *DRBRequiredToModifyItemNGRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBRequiredToModifyItemNGRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
