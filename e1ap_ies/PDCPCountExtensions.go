...
// PDCPCountExtensions is a generated type-safe wrapper for extensions.
type PDCPCountExtensions struct {
}

func (s *PDCPCountExtensions) Encode(w *per.Encoder) error {
...
func (s *PDCPCountExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
