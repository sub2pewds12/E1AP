...
// DRBsSubjectToCounterCheckItemEUTRANExtensions is a generated type-safe wrapper for extensions.
type DRBsSubjectToCounterCheckItemEUTRANExtensions struct {
}

func (s *DRBsSubjectToCounterCheckItemEUTRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBsSubjectToCounterCheckItemEUTRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
