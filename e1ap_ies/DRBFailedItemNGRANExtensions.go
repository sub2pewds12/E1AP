...
// DRBFailedItemNGRANExtensions is a generated type-safe wrapper for extensions.
type DRBFailedItemNGRANExtensions struct {
}

func (s *DRBFailedItemNGRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBFailedItemNGRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
