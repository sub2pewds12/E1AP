...
// PDUSessionToNotifyItemExtensions is a generated type-safe wrapper for extensions.
type PDUSessionToNotifyItemExtensions struct {
}

func (s *PDUSessionToNotifyItemExtensions) Encode(w *per.Encoder) error {
...
func (s *PDUSessionToNotifyItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
