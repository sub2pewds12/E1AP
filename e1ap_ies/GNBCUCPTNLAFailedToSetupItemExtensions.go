...
// GNBCUCPTNLAFailedToSetupItemExtensions is a generated type-safe wrapper for extensions.
type GNBCUCPTNLAFailedToSetupItemExtensions struct {
}

func (s *GNBCUCPTNLAFailedToSetupItemExtensions) Encode(w *per.Encoder) error {
...
func (s *GNBCUCPTNLAFailedToSetupItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
