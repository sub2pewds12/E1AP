...
func (s *DRBToSetupListEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBToSetupListEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBToSetupItemEUTRAN, length)
