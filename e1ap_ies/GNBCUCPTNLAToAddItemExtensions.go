...
// GNBCUCPTNLAToAddItemExtensions is a generated type-safe wrapper for extensions.
type GNBCUCPTNLAToAddItemExtensions struct {
}

func (s *GNBCUCPTNLAToAddItemExtensions) Encode(w *per.Encoder) error {
...
func (s *GNBCUCPTNLAToAddItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
