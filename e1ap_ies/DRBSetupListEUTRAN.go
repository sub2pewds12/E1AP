...
func (s *DRBSetupListEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBSetupListEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBSetupItemEUTRAN, length)
