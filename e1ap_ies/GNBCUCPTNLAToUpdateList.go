...
func (s *GNBCUCPTNLAToUpdateList) Encode(w *per.Encoder) (err error) {
...
func (s *GNBCUCPTNLAToUpdateList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]GNBCUCPTNLAToUpdateItem, length)
