...
// ROHCExtensions is a generated type-safe wrapper for extensions.
type ROHCExtensions struct {
}

func (s *ROHCExtensions) Encode(w *per.Encoder) error {
...
func (s *ROHCExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
