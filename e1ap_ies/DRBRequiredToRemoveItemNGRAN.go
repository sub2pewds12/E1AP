...
type DRBRequiredToRemoveItemNGRAN struct {
	DRBID        DRBID
	Cause        Cause
	IEExtensions *DRBRequiredToRemoveItemNGRANExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *DRBRequiredToRemoveItemNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBRequiredToRemoveItemNGRAN) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(2) {
		s.IEExtensions = new(DRBRequiredToRemoveItemNGRANExtensions)
