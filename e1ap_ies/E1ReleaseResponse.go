...
func (msg *E1ReleaseResponse) EncodeWithEncoder(e *per.Encoder) (err error) {
	ies, err := msg.toIes()
	if err != nil {
		return err
	}
...
// Decode implements the MessageUnmarshaller interface for E1ReleaseResponse.
func (msg *E1ReleaseResponse) Decode(data []byte) (diagList []CriticalityDiagnosticsIEItem, err error) {
	r := per.NewDecoder(data, per.APER)
	return msg.DecodeFromDecoder(r)
}

func (msg *E1ReleaseResponse) DecodeFromDecoder(r *per.Decoder) (diagList []CriticalityDiagnosticsIEItem, err error) {
...
func (decoder *E1ReleaseResponseDecoder) decodeIE(r *per.Decoder) (msgIe *E1APMessageIE, err error) {
