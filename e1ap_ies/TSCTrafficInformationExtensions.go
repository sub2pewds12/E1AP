...
// TSCTrafficInformationExtensions is a generated type-safe wrapper for extensions.
type TSCTrafficInformationExtensions struct {
}

func (s *TSCTrafficInformationExtensions) Encode(w *per.Encoder) error {
...
func (s *TSCTrafficInformationExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
