...
// SecurityInformationExtensions is a generated type-safe wrapper for extensions.
type SecurityInformationExtensions struct {
}

func (s *SecurityInformationExtensions) Encode(w *per.Encoder) error {
...
func (s *SecurityInformationExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
