...
func (s *ULUPTNLAddressToUpdateList) Encode(w *per.Encoder) (err error) {
...
func (s *ULUPTNLAddressToUpdateList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]ULUPTNLAddressToUpdateItem, length)
