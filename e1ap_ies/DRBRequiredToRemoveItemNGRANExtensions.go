...
// DRBRequiredToRemoveItemNGRANExtensions is a generated type-safe wrapper for extensions.
type DRBRequiredToRemoveItemNGRANExtensions struct {
}

func (s *DRBRequiredToRemoveItemNGRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBRequiredToRemoveItemNGRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
