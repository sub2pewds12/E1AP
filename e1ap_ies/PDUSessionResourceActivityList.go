...
func (s *PDUSessionResourceActivityList) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceActivityList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]PDUSessionResourceActivityItem, length)
