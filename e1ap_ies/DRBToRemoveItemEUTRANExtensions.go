...
// DRBToRemoveItemEUTRANExtensions is a generated type-safe wrapper for extensions.
type DRBToRemoveItemEUTRANExtensions struct {
}

func (s *DRBToRemoveItemEUTRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBToRemoveItemEUTRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
