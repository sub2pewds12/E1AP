...
type DRBFailedModItemEUTRAN struct {
	DRBID        DRBID
	Cause        Cause
	IEExtensions *DRBFailedModItemEUTRANExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *DRBFailedModItemEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBFailedModItemEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(2) {
		s.IEExtensions = new(DRBFailedModItemEUTRANExtensions)
