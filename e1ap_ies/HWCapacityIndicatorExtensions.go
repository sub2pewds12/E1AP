...
// HWCapacityIndicatorExtensions is a generated type-safe wrapper for extensions.
type HWCapacityIndicatorExtensions struct {
}

func (s *HWCapacityIndicatorExtensions) Encode(w *per.Encoder) error {
...
func (s *HWCapacityIndicatorExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
