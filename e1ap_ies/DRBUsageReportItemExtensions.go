...
// DRBUsageReportItemExtensions is a generated type-safe wrapper for extensions.
type DRBUsageReportItemExtensions struct {
}

func (s *DRBUsageReportItemExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBUsageReportItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
