...
// AlternativeQoSParaSetItemExtensions is a generated type-safe wrapper for extensions.
type AlternativeQoSParaSetItemExtensions struct {
}

func (s *AlternativeQoSParaSetItemExtensions) Encode(w *per.Encoder) error {
...
func (s *AlternativeQoSParaSetItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
