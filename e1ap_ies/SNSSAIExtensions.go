...
// SNSSAIExtensions is a generated type-safe wrapper for extensions.
type SNSSAIExtensions struct {
}

func (s *SNSSAIExtensions) Encode(w *per.Encoder) error {
...
func (s *SNSSAIExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
