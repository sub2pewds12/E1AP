...
func (s *DRBsSubjectToEarlyForwardingList) Encode(w *per.Encoder) (err error) {
...
func (s *DRBsSubjectToEarlyForwardingList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBsSubjectToEarlyForwardingItem, length)
