...
// NGRANQOSSupportItemExtensions is a generated type-safe wrapper for extensions.
type NGRANQOSSupportItemExtensions struct {
}

func (s *NGRANQOSSupportItemExtensions) Encode(w *per.Encoder) error {
...
func (s *NGRANQOSSupportItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
