...
// EUTRANQOSExtensions is a generated type-safe wrapper for extensions.
type EUTRANQOSExtensions struct {
}

func (s *EUTRANQOSExtensions) Encode(w *per.Encoder) error {
...
func (s *EUTRANQOSExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
