...
func (s *InitiatingMessage) Encode(w *aper.AperWriter) (err error) {
...
func (s *InitiatingMessage) Decode(r *aper.AperReader) (err error) {
	...
	if isExtensible {
		return fmt.Errorf("Extensions not yet implemented for InitiatingMessage")
	}
	return nil
}
