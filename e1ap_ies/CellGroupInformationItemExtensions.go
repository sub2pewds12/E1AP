...
func (s *CellGroupInformationItemExtensions) Encode(w *aper.AperWriter) error {
	...
	return fmt.Errorf("Encode not yet implemented for CellGroupInformationItemExtensions")
}
...
func (s *CellGroupInformationItemExtensions) Decode(r *aper.AperReader) error {
	...
	return fmt.Errorf("Decode not yet implemented for CellGroupInformationItemExtensions")
}
