...
// PacketErrorRateExtensions is a generated type-safe wrapper for extensions.
type PacketErrorRateExtensions struct {
}

func (s *PacketErrorRateExtensions) Encode(w *per.Encoder) error {
...
func (s *PacketErrorRateExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
