...
// NPNSupportInfoSNPNExtensions is a generated type-safe wrapper for extensions.
type NPNSupportInfoSNPNExtensions struct {
}

func (s *NPNSupportInfoSNPNExtensions) Encode(w *per.Encoder) error {
...
func (s *NPNSupportInfoSNPNExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
