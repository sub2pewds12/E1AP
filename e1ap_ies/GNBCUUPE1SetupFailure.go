...
func (msg *GNBCUUPE1SetupFailure) EncodeWithEncoder(e *per.Encoder) (err error) {
	ies, err := msg.toIes()
	if err != nil {
		return err
	}
...
func (msg *GNBCUUPE1SetupFailure) Encode(w io.Writer) error {
...
// Decode implements the MessageUnmarshaller interface for GNBCUUPE1SetupFailure.
func (msg *GNBCUUPE1SetupFailure) Decode(data []byte) (diagList []CriticalityDiagnosticsIEItem, err error) {
	r := per.NewDecoder(data, per.APER)
	return msg.DecodeFromDecoder(r)
}

func (msg *GNBCUUPE1SetupFailure) DecodeFromDecoder(r *per.Decoder) (diagList []CriticalityDiagnosticsIEItem, err error) {

	defer func() {
		if err != nil {
			err = fmt.Errorf("decode GNBCUUPE1SetupFailure failed: %w", err)
		}
	}()
...
func (decoder *GNBCUUPE1SetupFailureDecoder) decodeIE(r *per.Decoder) (msgIe *E1APMessageIE, err error) {
