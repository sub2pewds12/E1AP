...
type DRBSetupItemNGRAN struct {
	...
	IEExtensions                         *DRBSetupItemNGRANExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *DRBSetupItemNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBSetupItemNGRAN) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(5) {
		s.IEExtensions = new(DRBSetupItemNGRANExtensions)
