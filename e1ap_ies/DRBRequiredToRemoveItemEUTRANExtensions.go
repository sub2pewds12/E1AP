...
// DRBRequiredToRemoveItemEUTRANExtensions is a generated type-safe wrapper for extensions.
type DRBRequiredToRemoveItemEUTRANExtensions struct {
}

func (s *DRBRequiredToRemoveItemEUTRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBRequiredToRemoveItemEUTRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
