...
func (s *PDUSessionToNotifyList) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionToNotifyList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]PDUSessionToNotifyItem, length)
