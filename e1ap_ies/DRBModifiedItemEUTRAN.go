...
type DRBModifiedItemEUTRAN struct {
	...
	IEExtensions            *DRBModifiedItemEUTRANExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *DRBModifiedItemEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBModifiedItemEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(4) {
		s.IEExtensions = new(DRBModifiedItemEUTRANExtensions)
