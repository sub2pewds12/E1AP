...
func (s *DRBConfirmModifiedListNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBConfirmModifiedListNGRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBConfirmModifiedItemNGRAN, length)
