...
func (s *DRBRequiredToRemoveListEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBRequiredToRemoveListEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBRequiredToRemoveItemEUTRAN, length)
