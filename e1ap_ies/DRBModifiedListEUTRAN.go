...
func (s *DRBModifiedListEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBModifiedListEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBModifiedItemEUTRAN, length)
