...
type ResourceStatusResponse struct {
	...
	GNBCUCPMeasurementID   ResourceStatusResponseIEsIDGNBCUCPMeasurementID
	GNBCUUPMeasurementID   ResourceStatusResponseIEsIDGNBCUUPMeasurementID
...
func (msg *ResourceStatusResponse) EncodeWithEncoder(e *per.Encoder) (err error) {
	ies, err := msg.toIes()
	if err != nil {
		return err
	}
...
// Decode implements the MessageUnmarshaller interface for ResourceStatusResponse.
func (msg *ResourceStatusResponse) Decode(data []byte) (diagList []CriticalityDiagnosticsIEItem, err error) {
	r := per.NewDecoder(data, per.APER)
	return msg.DecodeFromDecoder(r)
}

func (msg *ResourceStatusResponse) DecodeFromDecoder(r *per.Decoder) (diagList []CriticalityDiagnosticsIEItem, err error) {
...
func (decoder *ResourceStatusResponseDecoder) decodeIE(r *per.Decoder) (msgIe *E1APMessageIE, err error) {
