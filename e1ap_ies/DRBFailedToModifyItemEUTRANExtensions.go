...
// DRBFailedToModifyItemEUTRANExtensions is a generated type-safe wrapper for extensions.
type DRBFailedToModifyItemEUTRANExtensions struct {
}

func (s *DRBFailedToModifyItemEUTRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBFailedToModifyItemEUTRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
