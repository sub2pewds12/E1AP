...
func (msg *GNBCUUPStatusIndication) Decode(buf []byte) (diagList []CriticalityDiagnosticsIEItem, err error) {
	defer func() {
		if err != nil {
...
func (decoder *GNBCUUPStatusIndicationDecoder) decodeIE(r *aper.AperReader) (msgIe *E1APMessageIE, err error) {
	...
	case ProtocolIEIDGNBCUUPOverloadInformation:
		...
		{
			val, err := ieR.ReadEnumerate(aper.Constraint{Lb: 0, Ub: 1}, false)
			if err != nil {
