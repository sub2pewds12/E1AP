...
func (s *DRBFailedModListNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBFailedModListNGRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBFailedModItemNGRAN, length)
