...
func (s *SliceSupportList) Encode(w *per.Encoder) (err error) {

	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxnoofSliceItems)}
...
func (s *SliceSupportList) Decode(r *per.Decoder) (err error) {
