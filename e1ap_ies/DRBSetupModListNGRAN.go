...
func (s *DRBSetupModListNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBSetupModListNGRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBSetupModItemNGRAN, length)
