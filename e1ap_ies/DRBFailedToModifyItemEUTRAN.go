...
type DRBFailedToModifyItemEUTRAN struct {
	DRBID        DRBID
	Cause        Cause
	IEExtensions *DRBFailedToModifyItemEUTRANExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *DRBFailedToModifyItemEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBFailedToModifyItemEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(2) {
		s.IEExtensions = new(DRBFailedToModifyItemEUTRANExtensions)
