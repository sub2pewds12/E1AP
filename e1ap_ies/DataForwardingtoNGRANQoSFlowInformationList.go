...
func (s *DataForwardingtoNGRANQoSFlowInformationList) Encode(w *per.Encoder) (err error) {
...
func (s *DataForwardingtoNGRANQoSFlowInformationList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DataForwardingtoNGRANQoSFlowInformationListItem, length)
