...
func (s *PDUSessionResourceFailedList) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceFailedList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]PDUSessionResourceFailedItem, length)
