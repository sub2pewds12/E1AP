...
type DataForwardingtoNGRANQoSFlowInformationListItem struct {
	...
	IEExtensions      *DataForwardingtoNGRANQoSFlowInformationListItemExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *DataForwardingtoNGRANQoSFlowInformationListItem) Encode(w *per.Encoder) (err error) {
...
func (s *DataForwardingtoNGRANQoSFlowInformationListItem) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(1) {
		s.IEExtensions = new(DataForwardingtoNGRANQoSFlowInformationListItemExtensions)
