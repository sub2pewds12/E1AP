...
func (s *DRBToModifyListEUTRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBToModifyListEUTRAN) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]DRBToModifyItemEUTRAN, length)
