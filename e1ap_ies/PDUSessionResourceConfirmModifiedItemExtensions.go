...
// PDUSessionResourceConfirmModifiedItemExtensions is a generated type-safe wrapper for extensions.
type PDUSessionResourceConfirmModifiedItemExtensions struct {
}

func (s *PDUSessionResourceConfirmModifiedItemExtensions) Encode(w *per.Encoder) error {
...
func (s *PDUSessionResourceConfirmModifiedItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
