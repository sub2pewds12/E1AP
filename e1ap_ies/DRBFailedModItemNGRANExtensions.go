...
// DRBFailedModItemNGRANExtensions is a generated type-safe wrapper for extensions.
type DRBFailedModItemNGRANExtensions struct {
}

func (s *DRBFailedModItemNGRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBFailedModItemNGRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
