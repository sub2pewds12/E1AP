...
type ResourceStatusFailure struct {
	...
	GNBCUCPMeasurementID   ResourceStatusFailureIEsIDGNBCUCPMeasurementID  `aper:"lb:1,ub:4095,mandatory,reject,ext"`
	GNBCUUPMeasurementID   *ResourceStatusFailureIEsIDGNBCUUPMeasurementID `aper:"lb:1,ub:4095,optional,ignore,ext"`
