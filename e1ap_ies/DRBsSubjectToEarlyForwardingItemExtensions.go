...
// DRBsSubjectToEarlyForwardingItemExtensions is a generated type-safe wrapper for extensions.
type DRBsSubjectToEarlyForwardingItemExtensions struct {
}

func (s *DRBsSubjectToEarlyForwardingItemExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBsSubjectToEarlyForwardingItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
