...
// MDTConfigurationExtensions is a generated type-safe wrapper for extensions.
type MDTConfigurationExtensions struct {
}

func (s *MDTConfigurationExtensions) Encode(w *per.Encoder) error {
...
func (s *MDTConfigurationExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
