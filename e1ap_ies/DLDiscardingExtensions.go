...
// DLDiscardingExtensions is a generated type-safe wrapper for extensions.
type DLDiscardingExtensions struct {
}

func (s *DLDiscardingExtensions) Encode(w *per.Encoder) error {
...
func (s *DLDiscardingExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
