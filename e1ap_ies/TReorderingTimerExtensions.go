...
// TReorderingTimerExtensions is a generated type-safe wrapper for extensions.
type TReorderingTimerExtensions struct {
}

func (s *TReorderingTimerExtensions) Encode(w *per.Encoder) error {
...
func (s *TReorderingTimerExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
