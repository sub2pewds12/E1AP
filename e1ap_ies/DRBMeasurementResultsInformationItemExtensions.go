...
// DRBMeasurementResultsInformationItemExtensions is a generated type-safe wrapper for extensions.
type DRBMeasurementResultsInformationItemExtensions struct {
}

func (s *DRBMeasurementResultsInformationItemExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBMeasurementResultsInformationItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
