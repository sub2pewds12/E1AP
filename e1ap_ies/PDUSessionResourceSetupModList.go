...
func (s *PDUSessionResourceSetupModList) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceSetupModList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]PDUSessionResourceSetupModItem, length)
