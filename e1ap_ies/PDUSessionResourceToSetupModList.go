...
func (s *PDUSessionResourceToSetupModList) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceToSetupModList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]PDUSessionResourceToSetupModItem, length)
