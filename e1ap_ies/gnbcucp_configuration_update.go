...
type GNBCUCPConfigurationUpdate struct {
	...
	GNBCUCPTNLAToAddList      []GNBCUCPTNLAToAddItem     `aper:"ub:MaxnoofTNLAssociations,optional,ignore,ext"`
	GNBCUCPTNLAToRemoveList   []GNBCUCPTNLAToRemoveItem  `aper:"ub:MaxnoofTNLAssociations,optional,ignore,ext"`
	GNBCUCPTNLAToUpdateList   []GNBCUCPTNLAToUpdateItem  `aper:"ub:MaxnoofTNLAssociations,optional,ignore,ext"`
