...
// ImmediateMDTExtensions is a generated type-safe wrapper for extensions.
type ImmediateMDTExtensions struct {
}

func (s *ImmediateMDTExtensions) Encode(w *per.Encoder) error {
...
func (s *ImmediateMDTExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
