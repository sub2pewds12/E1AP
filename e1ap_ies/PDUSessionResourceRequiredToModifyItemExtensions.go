...
func (s *PDUSessionResourceRequiredToModifyItemExtensions) Encode(w *aper.AperWriter) error {
	...
	return fmt.Errorf("Encode not yet implemented for PDUSessionResourceRequiredToModifyItemExtensions")
}
...
func (s *PDUSessionResourceRequiredToModifyItemExtensions) Decode(r *aper.AperReader) error {
	...
	return fmt.Errorf("Decode not yet implemented for PDUSessionResourceRequiredToModifyItemExtensions")
}
