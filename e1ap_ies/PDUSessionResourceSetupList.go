...
func (s *PDUSessionResourceSetupList) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceSetupList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]PDUSessionResourceSetupItem, length)
