...
type PDUSessionResourceToRemoveItem struct {
	...
	IEExtensions *PDUSessionResourceToRemoveItemExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *PDUSessionResourceToRemoveItem) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceToRemoveItem) Decode(r *per.Decoder) (err error) {
