...
type DRBFailedModItemNGRAN struct {
	DRBID        DRBID
	Cause        Cause
	IEExtensions *DRBFailedModItemNGRANExtensions
}

// Encode implements the aper.AperMarshaller interface.
func (s *DRBFailedModItemNGRAN) Encode(w *per.Encoder) (err error) {
...
func (s *DRBFailedModItemNGRAN) Decode(r *per.Decoder) (err error) {
	...
	if seqDecoder.IsComponentPresent(2) {
		s.IEExtensions = new(DRBFailedModItemNGRANExtensions)
