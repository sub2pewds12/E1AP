...
// GNBCUCPTNLASetupItemExtensions is a generated type-safe wrapper for extensions.
type GNBCUCPTNLASetupItemExtensions struct {
}

func (s *GNBCUCPTNLASetupItemExtensions) Encode(w *per.Encoder) error {
...
func (s *GNBCUCPTNLASetupItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
