...
// NGRANAllocationAndRetentionPriorityExtensions is a generated type-safe wrapper for extensions.
type NGRANAllocationAndRetentionPriorityExtensions struct {
}

func (s *NGRANAllocationAndRetentionPriorityExtensions) Encode(w *per.Encoder) error {
...
func (s *NGRANAllocationAndRetentionPriorityExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
