...
// DataForwardingtoNGRANQoSFlowInformationListItemExtensions is a generated type-safe wrapper for extensions.
type DataForwardingtoNGRANQoSFlowInformationListItemExtensions struct {
}

func (s *DataForwardingtoNGRANQoSFlowInformationListItemExtensions) Encode(w *per.Encoder) error {
...
func (s *DataForwardingtoNGRANQoSFlowInformationListItemExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
