...
func (s *PDUSessionResourceRequiredToModifyList) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceRequiredToModifyList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]PDUSessionResourceRequiredToModifyItem, length)
