...
// EHCParametersExtensions is a generated type-safe wrapper for extensions.
type EHCParametersExtensions struct {
}

func (s *EHCParametersExtensions) Encode(w *per.Encoder) error {
...
func (s *EHCParametersExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
