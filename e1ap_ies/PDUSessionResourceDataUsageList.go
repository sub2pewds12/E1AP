...
func (s *PDUSessionResourceDataUsageList) Encode(w *per.Encoder) (err error) {
...
func (s *PDUSessionResourceDataUsageList) Decode(r *per.Decoder) (err error) {
	...
	s.Value = make([]PDUSessionResourceDataUsageItem, length)
