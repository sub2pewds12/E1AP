...
// DRBConfirmModifiedItemNGRANExtensions is a generated type-safe wrapper for extensions.
type DRBConfirmModifiedItemNGRANExtensions struct {
}

func (s *DRBConfirmModifiedItemNGRANExtensions) Encode(w *per.Encoder) error {
...
func (s *DRBConfirmModifiedItemNGRANExtensions) Decode(r *per.Decoder) error {
	c := per.SizeConstraints{Extensible: false, Min: int64Ptr(1), Max: int64Ptr(MaxProtocolExtensions)}
